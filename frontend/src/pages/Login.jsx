        ...
        <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden px-6 font-display">
            ...
            >
                <div className="text-center mb-4 md:mb-8">
                    <div className="w-12 h-12 md:w-20 md:h-20 rounded-xl bg-black border-4 border-white/10 flex items-center justify-center mx-auto mb-6 md:mb-10 shadow-2xl transition-transform hover:scale-110">
                ...
                <form className="space-y-6 md:space-y-10" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="relative group">
                            ...
                            <input 
                                className="w-full bg-black border-4 border-white/5 rounded-2xl py-6 md:py-8 pl-16 md:pl-20 pr-8 text-lg md:text-xl text-white font-mono uppercase tracking-normaler focus:border-[#00FFD1]/50 focus:bg-black/60 focus:outline-none transition-all placeholder:text-slate-900 shadow-inner"
                                type="email" required 
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="relative group">
                            ...
                            <input 
                                className="w-full bg-black border-4 border-white/5 rounded-2xl py-6 md:py-8 pl-16 md:pl-20 pr-8 text-lg md:text-xl text-white font-mono focus:border-[#00FFD1]/50 focus:bg-black/60 focus:outline-none transition-all placeholder:text-slate-900 shadow-inner"
                    ...
                    <div className="pt-10">
                        <button 
                            type="submit" 
                            className="dimension-btn w-full !py-6 md:!py-8 rounded-2xl flex items-center justify-center gap-6 text-xl md:text-2xl font-black uppercase tracking-normal shadow-2xl active:scale-95 transition-all disabled:opacity-50" 
                            disabled={loading}
                        >
                            {loading ? (
                                <>
