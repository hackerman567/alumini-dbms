...
const Topbar = () => {
    ...
    return (
        <header className="h-28 px-10 lg:px-16 flex items-center justify-between bg-[#050510]/60 backdrop-blur-3xl border-b border-white/5 sticky top-0 z-[90] gap-5 md:p-6">
            {/* Navigation Path */}
            <div className="flex items-center gap-6 shrink-0">
                ...
                <div className="space-y-1 hidden sm:block">
                    <div className="font-mono text-sm text-slate-500 uppercase tracking-normal font-black">CURRENT LOCATION</div>
                    <div className="font-display text-lg font-black tracking-normal text-white flex items-center gap-3">
